...
char rightOptionNames[][20] = {"Spiral", "Limacon", "Cardiod", "Three Leaf", "Sphere", "Inner Clip", "Outer Clip", "Scale", "Rotate", "Flood Fill"};
int numberOfRightOptionItems = 10;
...
void highLightLeftOptionBox(int boxNumber)
{
	glColor3fv(colors[6]);
	glBegin(GL_POLYGON);
...
void highLightRightOptionBox(int boxNumber)
{
	glColor3fv(colors[9]);
	glBegin(GL_POLYGON);
